...
- **Every block** gets a "Starting pot" you can type an amount into — money that
  starts there rather than arriving along an arrow. Leave it blank for blocks
  that only pass money on.
